<template>
    <form class="form-inline">
        <div class="form-group">
            ...
            &nbsp;
            <select id="supplierSelector" class="form-control" v-model="selectedClient" @change.self="switchSupplier">
                <option v-for="supplierObject in uniqueSupplierObjList" :value="supplierObject.CUS_NO">
