                ...
                <thead>
                    <tr class="bg-warning">
                        <th class="text-center"
                            style="white-space:nowrap;">廠商</th>
                        <th class="text-center"
                            style="white-space:nowrap;">項目</th>
                        <th class="text-center">入廠日期</th>
                        <th class="text-center"
                            style="white-space:nowrap;">車次</th>
                        <th class="text-center">重量</th>
                    </tr>
                </thead>
                <tbody>
                    <shipmentOverviewRecord v-for="(monthlyShipmentOverview, index) in releventMonthlyShipmentOverview"
